...
public class Test5_6Cen2 extends HttpServlet{
	
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("test5.6执行");
		//地址栏http://localhost:8888/zb_servlet/day3/test6end
		req.getRequestDispatcher("../../Test5_7Cen3").forward(req, resp);
//		resp.sendRedirect("../../Test5_7Cen3");
	}
}
