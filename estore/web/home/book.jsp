		...
		<div class="cn5_top">
			...
			<div class="cn5_top_y center01">
				...
				<div class="cn5topy_2">
					...
					<h1 class="pro_title font15">${sessionScope.bookinfo.name}</h1>
					<div class="pro_price">
						<div class="pro_price_x">
							<p> briup价：<b>${sessionScope.bookinfo.price}</b> <a href="javascript:alert('敬请期待！');">(降价通知)</a></p>
						</div>
					</div>
			...
			<div class="c5_b2_right">
				...
				<div class="c5_b2_right_1 box">
					<div class="introduce_item">
						...
						<!-- ******************************************************* -->
						<ul>
							<li>书籍名称：${sessionScope.bookinfo.name}</li>
							<li>书籍编号：${sessionScope.bookinfo.id}</li>
						</ul>
						<!-- ******************************************************* -->
						<!-- ******************************************************* -->
